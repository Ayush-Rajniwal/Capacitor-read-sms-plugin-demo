import { IonButton, IonButtons, IonCard, IonCardContent, IonCardHeader, IonContent, IonHeader, IonPage, IonTitle, IonToolbar } from '@ionic/react';
    ...
    <IonPage>
      ...
      <IonContent fullscreen>
        <IonHeader collapse="condense">
          ...
          <IonButton onClick={()=>requestPermission()}>Requst SMS Permission</IonButton>
          <IonButton onClick={()=>checkPermission()}>Check current status of SMS Permission</IonButton>
    <div>
